...
## 📋 Repository Overview
This repository was created by Donna Faith Go and Paolo Antonio Mayo.
Here, we learned about different models used in quantitative finance such as the Markowitz Portfolio Optimization Model and the Fama-French Three-Factor Model.
Note that most concepts used in this work were not formally discussed within our degree requirements.
> 📄 **Full project details:** [mini project.ipynb](mini project.ipynb)  
